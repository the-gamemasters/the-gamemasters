...
const initMassive = () => __awaiter(void 0, void 0, void 0, function* () {
    let connector = (0, pg_connection_string_1.parse)(MASSIVE_CONNECTION_STRING);
    connector.ssl = { sslmode: "require", rejectUnauthorized: false };
    try {
        let db = yield (0, massive_1.default)(connector);
        app.set("db", db);
